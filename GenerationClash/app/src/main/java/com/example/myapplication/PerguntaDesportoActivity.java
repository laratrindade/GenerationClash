...
public class PerguntaDesportoActivity extends AppCompatActivity {
    ...
    private DesportoQuestions questions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pergunta_desporto);

        this.questions = new DesportoQuestions();
        ...
        switch (getImage(randomint)) {
            case 1:
                image.setImageResource(R.drawable.mundial);
                break;
            case 2:
            ...
            case 4:
                ...
                break;
            case 5:
                image.setImageResource(R.drawable.esports);
                break;
            default:
                break;
        }
    ...
    public void onClickButtonA(View V){
        ...
        if(getCorrectAnswer(randomint) == 1){
            ...
            Intent intent = new Intent(this, Errou_Desporto.class);
            startActivity(intent);
        }
    }
